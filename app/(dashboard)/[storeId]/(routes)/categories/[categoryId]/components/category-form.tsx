...
export const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  const description = initialData ? 'Selecciona la categoría y la campaña a editar' : 'Agregar una nueva categoría a la campaña';
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Nueva categoría" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
